...
const TOOLS = [
  ...
  { name: "tt_opportunities", description: "Ranked structural changes worth making: recurring middleware burden from the work ledger, priced by attention value and compared by setup cost. Objectives: attention (default), cash, roi, reliability, frontier. Pass budget (dollars) to get the best combination within it.", inputSchema: { type: "object", properties: { by: { type: "string", description: "attention | cash | roi | reliability | frontier" }, budget: { type: "number", description: "dollars to allocate across opportunities" } } } },
